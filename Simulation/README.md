...
**Data/Learning_rate_1/** - Simulated data from agents with learning rate α fixed to 1. These agents update Q-values fully on every trial and do not show the 2- or 3-back reward effect on stay behavior (Figure S2).
